                ...
                <div className="mt-8 text-center">
                    ...
                    <div className="flex flex-col items-center space-y-2 mt-4">
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-600">+91 8796755432</span>
                        </div>

                        <div className="flex items-center">
                            <FaEnvelope className="text-blue-500 mr-2"/>
                            <span className="text-gray-600">swiftbuy@gmail.com</span>
                        </div>

                        <div className="flex items-start">
                            <FaMapMarkedAlt className="text-blue-500  mr-2 mt-1"/>
                            <span className="text-gray-600">Fortune Terraces, Andheri West, Mumbai-400053</span>
                        </div>
                    </div>
                </div>
            </div>
